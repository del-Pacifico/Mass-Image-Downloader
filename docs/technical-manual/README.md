...
- [🏔️ Mass Image Downloader – Technical User Manual](#️-mass-image-downloader--technical-user-manual)
  ...
  - [🧩 4. Feature Flows](#-4-feature-flows)
    - [📸 4.1 Bulk Image Download](#-41-bulk-image-download)
      - [🚀 4.1.1 Trigger and Preconditions](#-411-trigger-and-preconditions)
      - [🔎 4.1.2 Selection and Validation Rules](#-412-selection-and-validation-rules)
      - [📥 4.1.3 Download and Tab Handling](#-413-download-and-tab-handling)
      - [🏷️ 4.1.4 Badge and Feedback Behavior](#️-414-badge-and-feedback-behavior)
    - [🌄 4.2 Extract Images from Galleries (With Direct Links)](#-42-extract-images-from-galleries-with-direct-links)
      - [🔗 4.2.1 Link-Based Extraction Logic](#-421-link-based-extraction-logic)
      - [🎛️ 4.2.2 Filtering and Qualification Rules](#️-422-filtering-and-qualification-rules)
      - [🧠 4.2.3 Background Orchestration](#-423-background-orchestration)
      - [🏷️ 4.2.4 Completion and Feedback](#️-424-completion-and-feedback)
    - [🖼️ 4.3 Extract Images from Galleries (Without Links)](#️-43-extract-images-from-galleries-without-links)
      - [👁️ 4.3.1 Visual Detection Logic](#️-431-visual-detection-logic)
      - [🎯 4.3.2 Image Qualification Rules](#-432-image-qualification-rules)
      - [🧠 4.3.3 Similarity Grouping and Selection](#-433-similarity-grouping-and-selection)
      - [🏷️ 4.3.4 Execution and Feedback](#️-434-execution-and-feedback)
    - [🔗 4.4 Extract Images from Web-Linked Galleries](#-44-extract-images-from-web-linked-galleries)
      - [🧭 4.4.1 Page-Opening Strategy](#-441-page-opening-strategy)
      - [⏱️ 4.4.2 Concurrency and Delay Control](#️-442-concurrency-and-delay-control)
    ...
    - [🔎 4.5 View Settings (Peek)](#-45-view-settings-peek)
      ...
      - [🎚️ 4.5.3 Transparency and Visibility Controls](#️-453-transparency-and-visibility-controls)
      - [🧭 4.5.4 When to Use Peek](#-454-when-to-use-peek)
    - [🕵️ 4.6 Image Inspector](#️-46-image-inspector)
      - [🧷 4.6.1 Activation and Overlay Behavior](#-461-activation-and-overlay-behavior)
  ...
  - [⚙️ 5. Settings Deep Dive](#️-5-settings-deep-dive)
    ...
    - [🏷️ 5.6 Filename Customization](#️-56-filename-customization)
    - [📸 5.7 Bulk Image Download Options](#-57-bulk-image-download-options)
    - [🖼️ 5.8 Gallery Options (Direct and Visual)](#️-58-gallery-options-direct-and-visual)
    - [🔗 5.9 Web-Linked Gallery Options](#-59-web-linked-gallery-options)
    - [🕵️ 5.10 Image Inspector Options](#️-510-image-inspector-options)
    - [🖱️ 5.11 One-click Download Icon Option](#️-511-one-click-download-icon-option)
  ...
  - [⌨️ 6. Hotkeys and Commands Reference](#️-6-hotkeys-and-commands-reference)
    ...
    - [🕵️ 6.2 Ctrl+Shift+M — Image Inspector](#️-62-ctrlshiftm--image-inspector)
  ...
  - [📎 10. Appendices](#-10-appendices)
    ...
    - [🏷️ 10.2 Badge States Reference](#️-102-badge-states-reference)
    - [🗂️ 10.3 Recommended Technical Presets](#️-103-recommended-technical-presets)
